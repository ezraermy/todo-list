...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_todoUI_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/todoUI.js */ \"./src/modules/todoUI.js\");\n/* harmony import */ var _modules_clearComplated_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/clearComplated.js */ \"./src/modules/clearComplated.js\");\n// import _ from 'lodash';\n\n\n\n\n\nconst form = document.querySelector('#inputForm');\nconst inputForm = document.getElementById('inputField');\nconst clear = document.getElementById('clear');\n\nwindow.addEventListener('load', () => {\n  (0,_modules_todoUI_js__WEBPACK_IMPORTED_MODULE_1__.showTodo)();\n});\n\nform.addEventListener('submit', (event) => {\n  event.preventDefault();\n  (0,_modules_todoUI_js__WEBPACK_IMPORTED_MODULE_1__.addTodo)(inputForm.value, false, (0,_modules_todoUI_js__WEBPACK_IMPORTED_MODULE_1__.getLocalStorage)().length + 1);\n  (0,_modules_todoUI_js__WEBPACK_IMPORTED_MODULE_1__.showTodo)();\n});\n\nclear.addEventListener('click', (e) => {\n  e.preventDefault();\n  (0,_modules_clearComplated_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])();\n  (0,_modules_todoUI_js__WEBPACK_IMPORTED_MODULE_1__.showTodo)();\n});\n\n//# sourceURL=webpack://to-do-list/./src/index.js?");

/***/ }),

/***/ "./src/modules/clearComplated.js":
/*!***************************************!*\
  !*** ./src/modules/clearComplated.js ***!
  \***************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nconst getLocalStorage = () => {\n  const storage = JSON.parse(localStorage.getItem('listStorage')) || [];\n  return storage;\n};\n\nconst clearCompleted = () => {\n  let unchecked = getLocalStorage().filter((item) => {\n    if (!item.completed) {\n      return item;\n    }\n    return null;\n  });\n\n  unchecked = unchecked.map((item, id) => {\n    item.index = id + 1;\n    return item;\n  });\n\n  localStorage.setItem('listStorage', JSON.stringify(unchecked));\n  window.location.reload();\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (clearCompleted);\n\n//# sourceURL=webpack://to-do-list/./src/modules/clearComplated.js?");
